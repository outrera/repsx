...
void Std2xSaI_ex8(uint8_t *src, DWORD srcPitch, uint8_t *dst, int w, int h);
void Super2xSaI_ex8(uint8_t *src, DWORD srcPitch, uint8_t *dst, int w, int h);
void SuperEagle_ex8(uint8_t *src, DWORD srcPitch, uint8_t *dst, int w, int h);
void Scale2x_ex8(uint8_t *src, DWORD srcPitch, uint8_t *dst, int w, int h);
void Scale3x_ex8(uint8_t *src, DWORD srcPitch, uint8_t *dst, int w, int h);
void hq2x_32(uint8_t *src, DWORD srcPitch, uint8_t *dst, int w, int h);
void hq3x_32(uint8_t *src, DWORD srcPitch, uint8_t *dst, int w, int h);

scaler Scalers[] = {
  {"None", 0},
  {"2xSaI", Std2xSaI_ex8},
  {"Super2xSaI", Super2xSaI_ex8},
  {"SuperEagle", Std2xSaI_ex8},
  {"Scale2x", Scale2x_ex8},
  {"hq2x", hq2x_32},
  {0,0}
};
...
void Std2xSaI_ex8(uint8_t *srcPtr, DWORD srcPitch, uint8_t *dstBitmap, int width, int height)
{
 DWORD dstPitch        = srcPitch<<1;
 DWORD srcPitchHalf    = srcPitch>>1;
 int   finWidth        = srcPitch>>2;
